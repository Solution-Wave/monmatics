...
class _DrawerTableCalendarState extends State<DrawerTableCalendar> {
  ...
  void initState() {
    ...
    // Initialize the selected calendar date to today's date
    selectedCalendarDate = DateTime.now();

    // Load tasks from the Hive box
    getTasksFromBox().then((_) {
      // Load tasks for today's date and set it as the initial value of _selectedEvents
      _selectedEvents.value = _listOfDayEvents(DateTime.now());

      // Debugging print statements
      print("Today's date: ${DateTime.now()}");
      print("Tasks for today: ${_selectedEvents.value}");
    });
  ...
  void clearFields() {
    setState(() {
      ...
      // Reset controllers to empty strings and initialize with current date
